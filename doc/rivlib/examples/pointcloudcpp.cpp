...
//
// NOTE: rivilib expects a working C++ 11 setup at minimum!
...
protected:
    ...
    // At the moment only the VQ-880-G, VQ-840-G, VUX-120 allow to split a mirror wheel rotation into multiple segments (lines).
            ...
            switch (paramId)
            {
                ...
                case 1416:
                {
                    ...
                    if (value == 1)
                        ...
                        sync_status = "correctly synchronized";
                    o << "GPS sync status of channel 1: " << sync_status << endl;
                    break;
                }
                case 1419:
                {
                    ...
                    if (value == 1)
                        ...
                        sync_status = "correctly synchronized";
                    o << "GPS sync status of channel 2: " << sync_status << endl;
                    break;
                }
                ...
                case 1309:
                {
                    o << "data recorder total memory of channel 1: " << value << " [MB]" << endl;
                    break;
                }
                case 1310:
                {
                    o << "data recorder used memory of channel 1: " << value << " [MB]" << endl;
                    break;
                }
                case 1508:
                {
                    o << "data recorder total memory of channel 2: " << value << " [MB]" << endl;
                    break;
                }
                case 1509:
                {
                    o << "data recorder used memory of channel 2: " << value << " [MB]" << endl;
                    break;
                }
