...
protected:
    ...
    void on_device_geometry_7D(const device_geometry_7D<iterator_type>& arg); //!< INTERNAL ONLY
    void on_device_geometry_laser_direction(const device_geometry_laser_direction<iterator_type>& arg); //! INTERNAL ONLY
    ...
    void on_channeled_shot_echoes(const channeled_shot_echoes<iterator_type>& arg); //!< INTERNAL ONLY
